...
# WARNING: Ensure imports from `wubby_python_api` comes after this line
from wubby_python_api import app, settings, db  # noqa
from wubby_python_api.cli import create_user, cli  # noqa
